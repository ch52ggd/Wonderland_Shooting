...
import { Component, ComponentConstructor, ComponentProto, ImageLike } from './wonderland.js';
/**
...
export declare class WASM {
    ...
    _jsManagerIndexCached: number | null;
    /**
...
export interface WASM {
    ...
    _wl_scene_ray_cast: (x: number, y: number, z: number, dx: number, dy: number, dz: number, group: number, maxDistance: number, outPtr: number) => void;
    ...
    _wl_physx_ray_cast: (x: number, y: number, z: number, dx: number, dy: number, dz: number, group: number, outPtr: number, maxDistance: number) => void;
